...
mysql -uadmin -p"Onstak@123" -e "CREATE DATABASE opencart_db" --connect-expired-password

mysql -uadmin -p"Onstak@123" -D opencart_db < /tmp/database.sql --connect-expired-password